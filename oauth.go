...
import (
	...
	"github.com/esap/dingtalk/util"
)

// OAUTH2PAGE oauth2鉴权
const (
	OAUTH2PAGE    = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=%v&redirect_uri=%v&response_type=code&scope=snsapi_base&state=110#dingtalk_redirect"
